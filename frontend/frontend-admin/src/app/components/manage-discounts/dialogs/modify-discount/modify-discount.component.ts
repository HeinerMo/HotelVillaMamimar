...
export class ModifyDiscountComponent implements AfterViewInit, OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<ModifyDiscountComponent>,
  ...
  ngOnInit(): void {
    ...
    this.roomTypeControl.setValue(this.discount.roomTypeId);
    this.beginingDateControl.setValue(new Date(this.discount.startingDate));
    this.setBeginingDateValue(this.beginingDateControl.value);
    this.endingDateControl.setValue(new Date(this.discount.endingDate));   
